<template>
  <section class="w-full min-h-screen h-fit flex flex-col pb-[240px]">
    ...
    >
      <h1 class="text-[16px] font-extrabold uppercase leading-[150%]">Orders</h1>
    ...
    <div class="w-full p-[24px] flex flex-col lg:flex-row gap-[16px]">
      ...
      <div class="stat-card">
        <div class="w-full">
          <div class="w-full flex items-center justify-between">
            <h2 class="text-[14px] font-semibold leading-[140%]">Average Order Value</h2>
            <div class="size-[16px]">
              <img
                class="size-full object-cover"
                src="../../../assets/svgs/navbar/orders.svg"
          ...
          <div class="text-[24px] font-extrabold">GHS {{ averageOrderValue }}</div>
        </div>
      </div>
    </div>
